...
User Function MVC003()
	...
	oBrowse:SetDescription( 'Histórico de Visitas aos Clientes MEX' )
...
Static Function ViewDef()
	...
	oView:EnableTitleView('Formulario' , 'Histórico de Visitas aos Clientes MEX' )	
...
Static Function ModelDef()
	Local oModel
	Local oStr1:= FWFormStruct( 1, 'MEX', /*bAvalCampo*/,/*lViewUsado*/ ) //Local oStr1:= FWFormStruct( 1, 'SX5', /*bAvalCampo*/,/*lViewUsado*/ ) // Construção de uma estrutura de dados

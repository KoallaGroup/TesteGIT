...
/*/
//-------------------------------------------------------------------
User Function xMVC001()
    /*Declarando as variáveis que serão utilizadas*/
	Local lRet := .T.
	Local aArea := ZZ0->(GetArea()) //SX5->(GetArea())
	Private oBrowse
	Private cChaveAux := ""
	...
	oBrowse:SetDescription( 'Cadastro de Atendimento aos Clientes' )
	oBrowse:AddLegend( "ZZ0_TIPO=='A'", "YELLOW", "Ativo" )
	oBrowse:AddLegend( "ZZ0_TIPO=='R'", "BLUE" , "Reativo" )

	//Adiciona um filtro ao browse
	//oBrowse:SetFilterDefault( "ZZ0_TIPO=='A'" )
...
Static Function ViewDef()
	...
	oView:AddField('Formulario' , oStr1,'CamposZZ0' ) 
	...
	oView:EnableTitleView('Formulario' , 'Atendimento aos Clientes' )	
...
Static Function ModelDef()
	Local oModel
	Local oStr1:= FWFormStruct( 1, 'ZZ0', /*bAvalCampo*/,/*lViewUsado*/ ) //Local oStr1:= FWFormStruct( 1, 'SX5', /*bAvalCampo*/,/*lViewUsado*/ ) // Construção de uma estrutura de dados
	...
	oModel:addFields('CamposZZ0',,oStr1,{|oModel|'<strong><span style="color: #ff0000;"><em>MVC001T</em></span></strong>(oModel)'},,)

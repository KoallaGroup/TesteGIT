			...
			If !Empty(SF2->F2_TRANSP)	
				...
				If !Empty(SA4->A4_XCOD)
					cMensFis += "Redespacho: "+Posicione("SA4",1,xFilial("SA4")+SA4->A4_XCOD,"A4_NOME");
							 +" - "+Posicione("SA4",1,xFilial("SA4")+SA4->A4_XCOD,"A4_CGC");
							 +" - "+Posicione("SA4",1,xFilial("SA4")+SA4->A4_XCOD,"A4_END");
					         +" - "+Posicione("SA4",1,xFilial("SA4")+SA4->A4_XCOD,"A4_BAIRRO");
							 +" - "+Posicione("SA4",1,xFilial("SA4")+SA4->A4_XCOD,"A4_MUN");
							 +" - "+Posicione("SA4",1,xFilial("SA4")+SA4->A4_XCOD,"A4_EST")
				EndIf                                                                           								
		       ...
		       EndIf   		
				...
				aadd(aProd,	{Len(aProd)+1,;  
					...
					((cAliasSD1)->D1_VALDESC + nDescRed + nDescIcm),;
				   	...
				   	IIF(SB1->(FieldPos("B1_CO	DSIMP"))<>0,SB1->B1_CODSIMP,""),; //codigo ANP do combustivel
					IIF(SB1->(FieldPos("B1_CODIF"))<>0,SB1->B1_CODIF,""),; //CODIF  
...
cString += '<vUnCom>'+ IIf(cF2Tipo == "C",ComplPreco(cTipo,cF2Tipo,aProd),ConvType(aProd[16],21,5))+'</vUnCom>'
...
If Len(aDI)>0 .And. ConvType(aDI[04][1]) == "I19"
	...
	If lDInoDanfe
		...
		//CUSTOMIZADO OBSERVAÇAO DO VALOR DE PIS E COFINS   /THIAGO NASCIMENTO
		cMsgDI += " Valor Pis: R$ " + ConvType(SF1->F1_VALIMP6,15,2) 
		cMsgDI += " Valor Cofins: R$ " + ConvType(SF1->F1_VALIMP5,15,2)
...
/*        
	   ...
	   //	dbSelectArea("XTEMP")
		*/                                                        
		cMsgDI += "  Valor Cofins Majorado: R$ " + ConvType(nMajora,15,2)

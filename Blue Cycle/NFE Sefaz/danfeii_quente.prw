...
oDanfe:Say(450, nAuxH + 2, "VAL.TOTAL", oFont08N:oFont)
nAuxH += aTamCol[9]
...
For nY := 1 To nLenItens
	...
	If lflag
		If nL > nMaxItemP2
			...
			oDanfe:Say(171+nLinhavers, nAuxH + 2, "VAL.TOTAL", oFont08N:oFont)
			nAuxH += aTamCol[9]
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		oDanfe:Say(171, nAuxH + 2, "VAL.TOTAL", oFont08N:oFont)
		nAuxH += aTamCol[9]
	...
	Else
		...
		oDanfe:Say(nLinha, nAuxH2+4, aAux[1][7][nY], oFont08:oFont) // QUANT
		nAuxH += aTamCol[7]+3
		...
		oDanfe:Say(nLinha, nAuxH2+5, aAux[1][9][nY], oFont08:oFont) // V. TOTAL
		nAuxH += aTamCol[09]+2

		nAuxH2 := len(aAux[1][10][nY]) + (nAuxH + (aTamCol[10]) - RetTamTex(aAux[1][10][nY], oFont08:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2+5, aAux[1][10][nY], oFont08:oFont) // BC. ICMS
		nAuxH += aTamCol[10]+2
		
		nAuxH2 := len(aAux[1][11][nY]) + (nAuxH + (aTamCol[11]) - RetTamTex(aAux[1][11][nY], oFont08:oFont, oDanfe))
		oDanfe:Say(nLinha, nAuxH2+3, aAux[1][11][nY], oFont08:oFont) // V. ICMS
		nAuxH += aTamCol[11]+2
...
if lFirsFolha
	oDanfe:Say(nRow2, nAuxH + 2, "V.UNIT. ", oFont08N:oFont)
endif	
nAuxH += aTamCol[4]
oDanfe:Box(nRow1, nAuxH, nAlt1, nAuxH + aTamCol[5])
if lFirsFolha
	oDanfe:Say(nRow2, nAuxH + 2, "VAL.TOTAL", oFont08N:oFont)
endif	

...
ฑฑบPrograma  ณDRGP210   บ Autor ณ Mauricio Cardoso   บ Data ณ  10/01/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Emissao dos Recibos de Pagamento no Formato Grafico        บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuno    ณRUNREPORT บ Autor ณ AP6 IDE            บ Data ณ  16/05/03   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Do While !Eof()
         ...
         ElseIf nTpImp == 2   // Folha                           
         	If  SRC->RC_PD != '122' .And. SRC->RC_PD != '146' .And. SRC->RC_PD != '147';
            	  ...
            	  .And. SRC->RC_PD != '207' .And. SRC->RC_PD != '244'.And. SRC->RC_PD != '404' .And. SRC->RC_PD != '447' .And. SRC->RC_PD != '125'; 
            	   ...
            	   //.And. SRC->RC_PD != '125'        
	          //Verbas  removidas do contra-cheque e grแfico a pedido da Nayara - '120', '125' '121, 126 125 488  
	            If SRV->RV_TIPOCOD == "1"
	               Aadd(aProv,{SRC->RC_PD,SRV->RV_DESC,SRC->RC_HORAS,SRC->RC_VALOR,0})
	               nTotProv += SRC->RC_VALOR
   ...
   For nRecibos := 1 To 3
       ...
       oPrint:SayBitmap( 0030,0140,aBmp2,0600,0140 )
   	   ...
   	   oPrint:SayBitmap( 1620,0140,aBmp2,0600,0140 )   //MAURICIO LOGO DA 2ชPAGINA

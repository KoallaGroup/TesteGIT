...
AADD(aRotina,{ OemToAnsi("Marcar Todos") ,"U_MARCAR" , 0, 3})
AADD(aRotina,{ OemToAnsi("Desmarcar Todos") ,"U_DESMAR" , 0, 4})
AADD(aRotina,{ OemToAnsi("Inverter Todos") ,"U_MARKALL" , 0, 5})   
AADD(aRotina,{ OemToAnsi("Sair") ,"" , 0, 5})
...
DbSelectArea("TRB")
DbGotop()
//MarkBrow( 'TRB', 'A1_OK',,_afields,.F., cMark,'u_MarkAll()',,,,'u_Mark()',{|| u_MarkAll()},,,,,,,.T.) 
MarkBrow('TRB', 'A1_OK'		,""	,_afields	,.F.	,cMark,'u_MarkAll()',,,,'u_Mark()',{|| u_MarkAll()},,,,,,,) 

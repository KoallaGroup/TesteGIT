...
|-----------------------------------------------------------------------------------------------|
|	Descrição : Relatório de Vendas de Promoções                                                |
|-----------------------------------------------------------------------------------------------|
*/
...
Private oButSub
Private cTitButSub	:= "Identificação"
...
Aadd(aPergs,{"Produto até   	"	,"","","mv_ch3","C",TamSx3("B1_COD")[1]		,0,0,"G","","MV_PAR03","","","","","","","","","","","","","","","","","","","","","","","","",""	,"","","",""})
...
Aadd(aPergs,{"Data até      	"	,"","","mv_ch8","D",08						,0,0,"G","","MV_PAR08","","","","","","","","","","","","","","","","","","","","","","","","",""	,"","","",""})
Aadd(aPergs,{"Identificação de	"	,"","","mv_ch9","C",TamSx3("Z9_COD")[1]		,0,0,"G","","MV_PAR09","","","","","","","","","","","","","","","","","","","","","","","","",""   ,"","","",""})
Aadd(aPergs,{"Identificação até "	,"","","mv_chA","C",TamSx3("Z9_COD")[1]		,0,0,"G","","MV_PAR10","","","","","","","","","","","","","","","","","","","","","","","","",""	,"","","",""})
Aadd(aPergs,{"Marca de    		"	,"","","mv_chB","C",TamSx3("Z5_CODIGO")[1]	,0,0,"G","","MV_PAR11","","","","","","","","","","","","","","","","","","","","","","","","",""   ,"","","",""})
Aadd(aPergs,{"Marca até   		"	,"","","mv_chC","C",TamSx3("Z5_CODIGO")[1]	,0,0,"G","","MV_PAR12","","","","","","","","","","","","","","","","","","","","","","","","",""	,"","","",""})
...
DEFINE MSDIALOG oDlg TITLE "Relatório de Vendas de Promoções" FROM 000, 000  TO 420, 700 COLORS 0, 16777215 PIXEL
oDlg:lMaximized := .f.
...
@ nLinSay, aPosGet[1,01] SAY      oSay5       PROMPT "Identificação de  "                       	SIZE 040, 008	OF oDlg COLORS 0, 16777215 PIXEL
...
@ nLinSay, aPosGet[1,01] SAY      oSay6       PROMPT "Identificação até "                       	SIZE 040, 008	OF oDlg COLORS 0, 16777215 PIXEL
...
@ nLinSay, aPosGet[1,01] SAY      oSay8       PROMPT "Marca até "                         			SIZE 030, 008	OF oDlg COLORS 0, 16777215 PIXEL
...
@ nLinSay, aPosGet[1,01] SAY      oSay3       PROMPT "Item até "                         			SIZE 030, 008	OF oDlg COLORS 0, 16777215 PIXEL
...
@ nLinSay,aPosGet[1,01]    GROUP   	oGroup1 TO nLinSay+30,aPosGet[1,04] PROMPT "Período 1"   						OF oDlg COLOR 255, 16777215 Pixel
...
@ nLinSay,aPosGet[1,04]+1  GROUP	oGroup1 TO nLinSay+30,aPosGet[1,05] PROMPT "Período 2"   						OF oDlg COLOR 255, 16777215 Pixel
...
@ nLinSay,   aPosGet[1,01]   GROUP	oGroup1 TO nLinSay+30,aPosGet[1,04] PROMPT "Tipo de Relatório"			  		OF oDlg COLOR 255, 16777215 Pixel
@ nLinSay+8, aPosGet[1,01]+4 RADIO	oRadSub 	  VAR nTipo   Prompt OemToAnsi("Identificação"), OemToAnsi("Marca") SIZE 080, 008 OF oDlg Pixel

@ nLinSay,   aPosGet[1,04]+1   GROUP	oGroup1 TO nLinSay+30,aPosGet[1,05] PROMPT "Relatório Por"			  		OF oDlg COLOR 255, 16777215 Pixel
...
|	Desenvolvido por Rogério Alves - Anadi                                                      |
|-----------------------------------------------------------------------------------------------|
|	Descrição : Rotina para preenchimento da tabela PA7 e geração do relatório em crystal       |
|-----------------------------------------------------------------------------------------------|
*/
...
If Empty(cEmpr) .and. lConsol == 1
	...
	MsgAlert("Para o tipo de relatório 'LOCAL', favor preencher o campo Local ")
	lRet := .F.
...
|	Desenvolvido por Rogério Alves - Anadi                                                      |
|-----------------------------------------------------------------------------------------------|
|	Descrição : Valida existência do produto                                                    |
|-----------------------------------------------------------------------------------------------|
*/
...
|	Desenvolvido por Rogério Alves - Anadi                                                      |
|-----------------------------------------------------------------------------------------------|
|	Descrição : Bloqueio dos campos de marca ou identificação                                   |
|-----------------------------------------------------------------------------------------------|
*/

User Function AtuTipo(PTipo)

if PTipo == 1 //Identificação

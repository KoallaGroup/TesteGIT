...
DEFINE MSDIALOG oDlg TITLE "PESO / EMBALAGEM" FROM 000, 000  TO 200, 500 COLORS 0, 16777215 PIXEL
    ...
    @ 060, 041 MSGET oMaster VAR nMaster SIZE 033, 010 OF oDlg PICTURE "@E 99999" VALID nMaster >= 0 COLORS 0, 16777215 PIXEL
    @ 061, 088 SAY oSay5 PROMPT "Qtd. Indiv." SIZE 027, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 060, 117 MSGET oQEmb VAR nQEmb SIZE 035, 010 OF oDlg PICTURE "@E 999999999" VALID nQEmb >= 0 COLORS 0, 16777215 PIXEL
    @ 061, 167 SAY oSay6 PROMPT "Qtd. Venda" SIZE 030, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 060, 201 MSGET oMultpl VAR nMultpl SIZE 038, 010 OF oDlg PICTURE "@E 99999" VALID nMultpl >= 0 COLORS 0, 16777215 PIXEL

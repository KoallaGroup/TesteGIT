...
@ nLinGet, aPosGet[1,02]+30	MSCOMBOBOX oOperacao VAR cOperacao ITEMS{"Venda","Transferência","Ambos"} SIZE 050, 008 OF oDlg COLORS 0, 16777215 PIXEL
nLinSay += 13
nLinGet += 13
...
aAdd( aSx1, {cLocalDe, cLocalAte, DTOS(dDataini), DTOS(dDataFim), cUF, cSegisp, cRepres, Alltrim(Str(cOperacao)), Alltrim(Str(_cIcmsSt)) } )

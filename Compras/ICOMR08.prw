...
// ok 	@ aPosObj[1,3]-35,aStru[2] Say cObs  			 	 SIZE 250,022 of oDlgTM1 PIXEL  
	@ aPosObj[1,3]-35,aStru[2] SCROLLBOX oScrollB1 VERTICAL SIZE 030, 250 OF oDlgTM1 BORDER
	@ 000,000 Get cObs  MEMO			 SIZE 250,100 of oScrollB1 MULTILINE PIXEL
...
//	@ aPosObj[1,3]-07,305 	   Button oButton PROMPT "Retornar" SIZE 040,015 OF oDlgTM1 PIXEL ACTION (oDlgTM1:End())
	@ aPosObj[1,3]-07,aStru[1] 	   Button oButton PROMPT "Retornar" SIZE 040,015 OF oDlgTM1 PIXEL ACTION (oDlgTM1:End())
...
If(!Empty(aObsAux) .AND. Len(aObsAux) % 8 = 0)
	cObs := Alltrim(cObs) + _cPedido + ";" + Chr(10) + Chr(13)
Else
	cObs := Alltrim(cObs) + _cPedido + ";"
EndIf

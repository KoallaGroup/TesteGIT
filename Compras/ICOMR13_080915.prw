...
Private oGet5
Private cGet5 := Space(3)
Private oGet6
Private cGet6 := Space(3)
Private oGet7
Private cGet7 := Space(15)
Private oGet8
Private cGet8 := Space(15)
Private oGet9
...
Aadd(aEmpresas1,{.F.,'', ''})
  ...
  DEFINE MSDIALOG oDlg TITLE "Relatorio de Compras Nacional:" FROM 000, 000  TO 570, 700 COLORS 0, 16777215 PIXEL
    ...
    @ 024, 047 MSGET oGet3 VAR cGet3 SIZE 027, 010 OF oDlg COLORS 0, 16777215 PIXEL
    
    @ 040, 015 SAY oSay3 PROMPT "Ate o Grupo:" SIZE 032, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 038, 047 MSGET oGet4 VAR cGet4 SIZE 027, 010 OF oDlg COLORS 0, 16777215 PIXEL
    
    @ 025, 094 SAY oSay4 PROMPT "A Partir da Procedencia:" SIZE 059, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 024, 154 MSGET oGet5 VAR cGet5 SIZE 027, 010 OF oDlg COLORS 0, 16777215 PIXEL
    
    @ 040, 106 SAY oSay5 PROMPT "Ate a Procedencia:" SIZE 048, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 038, 154 MSGET oGet6 VAR cGet6 SIZE 027, 010 OF oDlg COLORS 0, 16777215 PIXEL
    
    @ 059, 008 SAY oSay6 PROMPT "A Partir do Item:" SIZE 040, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 058, 047 MSGET oGet7 VAR cGet7 SIZE 134, 010 OF oDlg COLORS 0, 16777215 PIXEL F3 "SB1LIK"
    
    @ 075, 020 SAY oSay7 PROMPT "Ate o Item:" SIZE 027, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 073, 047 MSGET oGet8 VAR cGet8 SIZE 134, 010 OF oDlg COLORS 0, 16777215 PIXEL F3 "SB1LIK"
    ...
    @ 111, 047 GROUP oGroup1 TO 163, 180 PROMPT "  Periodo 1  " OF oDlg COLOR 0, 16777215 PIXEL
    ...
    @ 142, 067 SAY oSay10 PROMPT "Ate a Data:" SIZE 029, 007 OF oDlg COLORS 0, 16777215 PIXEL
    @ 141, 099 MSGET oGet12 VAR cGet12 SIZE 060, 010 OF oDlg COLORS 0, 16777215 PIXEL
    
    @ 168, 047 GROUP oGroup2 TO 220, 180 PROMPT "  Periodo 2  " OF oDlg COLOR 0, 16777215 PIXEL
    ...
    @ 199, 067 SAY oSay12 PROMPT "Ate a Data:" SIZE 029, 007 OF oDlg COLORS 0, 16777215 PIXEL
    ...
    @ 007, 210 GROUP oGroup3 TO 237, 340 PROMPT "  Unidades de Federacao  " OF oDlg COLOR 0, 16777215 PIXEL 
...
PutHtml({"Proc","Codigo","Descrição","Un.","Venda P1","Venda P2","Estoque","Compras","Pre-Faturado","Embal" },1,1) 
...
_cQuery := " SELECT B1__PROC, B1_COD, B1_DESC, B1_UM, B1__MARCA, B1__EMBMAS,	"  + Chr(13)  
...
_cQuery += " WHERE D_E_L_E_T_ <> '*' AND B1__SEGISP = '1'						"  + Chr(13)  

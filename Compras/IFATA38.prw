...
mSQL += " LEFT JOIN " +RetSqlName("SZ9")+" SZ9 ON Z9_FILIAL = '"+xFilial("SZ9")+"' AND Z9_PRODUTO = B1_COD " +Chr(13)
...
If !Empty(cIdDe)
	mSQL += " And Z9_COD Between '"+cIdDe+"' AND '"+cIdAte+"' And SZ9.D_E_L_E_T_ = ' ' " + Chr(13)
EndIf

...
/*/
//--------------------------------------------------------------------
User Function UPDSZV( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSZV" )
				Else
...
aAdd( aSX2, { ;
	...
	'DISTRIBUICAO CROSSDOKING'												, ; //X2_NOME
	'DISTRIBUICAO CROSSDOKING'												, ; //X2_NOMESPA
	'DISTRIBUICAO CROSSDOKING'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Item NF'																, .T. }, ; //X3_TITSPA
	{ 'Item NF'																, .T. }, ; //X3_TITENG
	{ 'Item NF'																, .T. }, ; //X3_DESCRIC
	{ 'Item NF'																, .T. }, ; //X3_DESCSPA
	{ 'Item NF'																, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ '@E 99,999,999,999,999,999'											, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'Positivo() .and. U_MCrosQtd()'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SZV'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZV_DESCFIL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Filial'															, .T. }, ; //X3_TITULO
	{ 'Nome Filial'															, .T. }, ; //X3_TITSPA
	{ 'Nome Filial'															, .T. }, ; //X3_TITENG
	{ 'Nome Filial'															, .T. }, ; //X3_DESCRIC
	{ 'Nome Filial'															, .T. }, ; //X3_DESCSPA
	{ 'Nome Filial'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IF( INCLUI, "", POSICIONE( "SM0", 1, CEMPANT + SZV->ZV_CODFIL, "M0_NOMECOM" ) )', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSIX, { ;
	'SZV'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZV_FILIAL+ZV_DOC+ZV_SERIE+ZV_FORNECE+ZV_LOJA+ZV_ITEM'					, ; //CHAVE
	'Documento+Serie+Fornecedor+Loja+Item NF'								, ; //DESCRICAO
	'Documento+Serie+Fornecedor+Loja+Item NF'								, ; //DESCSPA
	'Documento+Serie+Fornecedor+Loja+Item NF'								, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ

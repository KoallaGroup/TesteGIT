...
aHeaderPed 	:= {}
aCpoHeader  := {"UA_FILIAL","UA_NUM","UA_EMISSAO","UA__PRVFAT","UB__QTDSOL","UA__STATUS","UA_VEND","UA_TMK","UA__RESEST","UA_VLRLIQ","UA_VLRLIQ","UA_FRETE","UA_VALBRUT"/*,"A4_NREDUZ","UA__REDESP","A1_NREDUZ","A1_MUN","A1_EST","A1_DDD","A1_TEL"*/} 
aCpoTitulo	:= {"Fil","Pedido","Dt.Pedido","Dt.Prev.Fat","Qtde Itens","Sit","Rp","Op","Est","Vlr. Peça","Vlr. Pneu","Frete","Valor Pedido"/*,"Transp","Redesp","Cliente","Mun","UF","DDD","Tel"*/ }
...
Local nPosCli5  := ASCAN(aHeaderPed, { |x| AllTrim(x[2]) == "UB__QTDSOL" })
Local nQuant 	:= 0
Local nPeca		:= 0
Local nPneu		:= 0
Local nTotPec	:= 0
...
_cQuery := "SELECT DISTINCT UA_FILIAL, UA_NUM, UA_EMISSAO, UA__PRVFAT, COUNT(UB_VLRITEM) AS QTDITENS, UA__STATUS, UA_VEND, UA_TMK, UA__RESEST, A1_NREDUZ, A1_MUN, A1_EST, A1_DDD, A1_TEL, "           + CHR(10) + CHR(13)
...
while !TRBSUA->(eof())
	...
	oGetPD1:Acols[nn][nPosCli5]     := TRBSUA->QTDITENS
